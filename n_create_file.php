...
$sql = 'INSERT INTO nurse_service(id, n_id, office_name, comment, link, tel, mail, face_img, created_at, updated_at) VALUES(NULL, :n_id, :office_name, :comment, :link, :tel, :mail, :face_img, now(), now())';
