...
$sql = "SELECT * FROM patient_needs LEFT OUTER JOIN ( SELECT needs_id, COUNT(id) AS appo_count FROM appo_table GROUP BY needs_id ) AS result_table ON patient_needs.id = result_table.needs_id WHERE needs_category LIKE :search_word";
